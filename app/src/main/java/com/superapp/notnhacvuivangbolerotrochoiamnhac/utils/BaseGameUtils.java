...
public class BaseGameUtils {
     ...
     */
//    public static void makeSimpleDialog(Activity activity, String message) {
        ...
        switch (actResp) {
            case GamesActivityResultCodes.RESULT_APP_MISCONFIGURED:
                errorDialog = makeSimpleDialog(activity,
                        "Đăng nhập không thành công. Vui lòng thử lại sau. Miss Configed");
                break;
            case GamesActivityResultCodes.RESULT_SIGN_IN_FAILED:
                errorDialog = makeSimpleDialog(activity,
                        "Đăng nhập không thành công. Vui lòng thử lại sau. Sign Failed");
                break;
            case GamesActivityResultCodes.RESULT_LICENSE_FAILED:
                errorDialog = makeSimpleDialog(activity,
                        "Đăng nhập không thành công. Vui lòng thử lại sau. License Failed");
                break;
            default:
